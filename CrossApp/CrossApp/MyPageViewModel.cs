    ...
    public class MyPageViewModel : INotifyPropertyChanged
        {
            ...
            public MyPageViewModel()
            {
                ...
                MessagingCenter.Subscribe<App>(this, "Sleep", (obj) =>
                {
                    ...
                    if (_isConnected)
                        DependencyService.Get<IBluetoothManager>().Cancel();
                ...
                MessagingCenter.Subscribe<App>(this, "Resume", (obj) =>
                {
                    ...
                    if (_isConnected)
                        DependencyService.Get<IBluetoothManager>().Start(SelectedBthDevice, _sleepTime, true);
                ...
                try
                {
                    ...
                    ListOfDevices = DependencyService.Get<IBluetoothManager>().PairedDevices();
                }
                catch (Exception ex)
                {
