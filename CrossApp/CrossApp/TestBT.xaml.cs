...
namespace CrossApp
{
    ...
    public partial class TestBT : ContentPage
    {
        IBluetoothLE ble;
        IAdapter adapter;
        ...
        public TestBT()
        {
            ...
            deviceView = new DeviceViewModel();
            BindingContext = deviceView;
            InitializeComponent();
        ...
        private async void btnConnect_Clicked(object sender, EventArgs e)
        {
            try
            {
                DependencyService.Get<IBluetoothManager>().RequestDiscoverable();
                DependencyService.Get<IBluetoothManager>().Paring();
                //    if (device != null)
                //    {
